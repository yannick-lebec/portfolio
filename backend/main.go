...
func main() {
	...
	r.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"http://localhost:5173", "http://localhost:3000", "https://yannick-le-bec.vercel.app", "https://portfolio-fawn-eight-gbohkq5b5o.vercel.app", "https://yannick-le-bec.dev", "https://www.yannick-le-bec.dev"},
