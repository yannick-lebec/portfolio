...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-[#050d1a]/85 backdrop-blur-md border-b border-cyan-900/30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">

          {/* Logo avec dégradé */}
          <Link to="/" className="font-bold text-xl text-white hover:text-cyan-400 transition-colors duration-300">
